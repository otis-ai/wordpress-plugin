...
use OtisAI\options\OtisAIOptions;

/**
 * Class that wraps the functions to access options related to the Otis account.
 */
class AccountOptions extends OtisAIOptions {
	 ...
	 * Set portal id.
	 *
	 * @param Number $portal_id Otis portal id.
	 */
